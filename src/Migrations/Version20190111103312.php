 ...
 */
final class Version20190111103312 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tbl_course ADD CONSTRAINT FK_9B380606159D9B5E FOREIGN KEY (level_id) REFERENCES tbl_level (id)');
        $this->addSql('CREATE INDEX IDX_9B380606159D9B5E ON tbl_course (level_id)');
    }
}
